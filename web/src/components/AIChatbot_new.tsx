...
export default function AIChatbot() {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'assistant', 
      content: '👋 Hi! I\'m your AI financial assistant. I can help analyze your spending patterns, suggest budget optimizations, and answer questions about your finances!', 
      timestamp: Date.now() 
    }
  ]);
  ...
  const sendMessage = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        } else if (data.details?.includes('OpenAI API key not set')) {
          errorMessage = '🔧 **AI Service Setup Required**: The AI features need an OpenAI API key to work. You can still use all other finance tracking features! Check the setup guide for more info.';
